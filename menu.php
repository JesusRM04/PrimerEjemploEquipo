        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="certificaciones.php">Articulos</a>
                    </li>
                    
                    <li class="nav-item">
                        <a class="nav-link active" href="contacto.php">Suscribirte</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="examinfo.php">Examenes</a></li>
                        </ul>
                    </li>
                </ul>
                <?php
